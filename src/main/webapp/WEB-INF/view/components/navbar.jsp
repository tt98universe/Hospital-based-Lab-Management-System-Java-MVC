<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
   ...
   <i><b><span class="text-color">ABC Hospital Laboratories</span></b></i>
  </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              The Hospital-based ABC Lab Management Digitalized System was introduced to solve the complications coming 	from managing all the paper works of every patient associated with the various departments of hospitalization with 	confidentiality. This system provides the ability to manage all the paperwork digitalizedin one place, reducing the 	work of staff in arranging and analyzing the paperwork of the patients.
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+94 777186015<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">abclab2024helpdesk@gmail.com
            </b>
        </p>
        </div>
      </div>
