<%@page import="com.abclabmanagement.constants.DatabaseConstants.TreatmentStatus"%>
<%@page import="com.abclabmanagement.constants.DatabaseConstants.BillMade"%>
<%@page import="com.abclabmanagement.constants.DatabaseConstants.WantMedicinesFromHospital"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
<%@ page import ="com.abclabmanagement.model.*"%>
<%@ page import ="com.abclabmanagement.dao.*"%>
<%@ page import ="com.abclabmanagement.resource.*"%>
<%@ page import ="com.abclabmanagement.constants.*"%>
